...
class CameraStreamer:
    def __init__(self):
        ...
        self.cam_right = cv2.VideoCapture(right_pipeline, cv2.CAP_GSTREAMER)
    ...
    def update_stream(self, session):
        ...
        distance_to_camera = 3.5*self.cam_mat[0][0] / frame_left_rgb.shape[1] # TODO: remove this hard-coded 2 multiplier
