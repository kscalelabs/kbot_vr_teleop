...
class HandTrackingHandler:
    ...
    def handle_hand_tracking(self, event):
        """
        Handle hand tracking data from VR, compute arm and finger joints, and send to robot.
        """
        ...
        # Compute arm and finger joint angles
        ...
        # Send arm commands (including gripper) via Kinfer
