...
class UDPHandler:
    ...
    def _send_udp(self, right_arm_angles, left_arm_angles, right_finger_angles, left_finger_angles):
        payload = {
            "timestamp": time.time(),
            "joints": {
                "11": float(np.rad2deg(left_arm_angles[0])),
                "12": float(np.rad2deg(left_arm_angles[1])),
                "13": float(np.rad2deg(left_arm_angles[2])),
                "14": float(np.rad2deg(left_arm_angles[3])),
                "15": float(np.rad2deg(left_arm_angles[4])),
                "21": float(np.rad2deg(right_arm_angles[0])),
                "22": float(np.rad2deg(right_arm_angles[1])),
                "23": float(np.rad2deg(right_arm_angles[2])),
                "24": float(np.rad2deg(right_arm_angles[3])),
                "25": float(np.rad2deg(right_arm_angles[4]))
            },
